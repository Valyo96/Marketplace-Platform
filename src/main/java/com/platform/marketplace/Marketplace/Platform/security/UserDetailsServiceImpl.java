...
import com.platform.marketplace.Marketplace.Platform.service.email.EmailService;
...
public class UserDetailsServiceImpl implements UserDetailsService {
   ...
   private EmailService emailSender;
    ...
    public String signUpUser (OrganisationDTO user){
        String token = organisationService.register(user);
        String link = "http://localhost:8080/register/v1/registration/confirm?token=" + token;
        emailSender.send(
                user.getEmail(),
